    ...
    return Scaffold(
      ...
      appBar: AppBar(
       ...
       body:isLoaded? StreamBuilder<QuerySnapshot<Map<String,dynamic>>>(
           stream:  FirebaseFirestore.instance.collection('Orders').doc(user!.uid).collection('MyOrders').where('Status',isEqualTo: 'Done').snapshots(),
                               ...
                               Padding(
                                 ...
                                 child: Row(
                                   ...
                                   children: [
                                     ...
                                     styled(text:data['Status'], color: Colors.green, weight: FontWeight.normal, size:h*0.02),
                                   ],
                                 ),
                               )
                             ],
       ...
       ):Center(child: Container(width: 150,height: 150,
